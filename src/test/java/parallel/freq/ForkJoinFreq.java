...
/**
 * Class should create a map animalFrequency: animal -> frequency
 *
 * It should be done in 3 ways: - using Fork/Join algorithm - using map/reduce (use collect() method) - using

...
/**
 * Source taken from: http://www.infoq.com/articles/forkjoin-to-parallel-streams
 */
public class Variance {
  ...
  public static void main(String... args) {
    ...
    System.out
        .println("Imperative version done in: " + measurePerf(Variance::varianceImperative, population) + " msecs");
    System.out
        .println("Parallel streams version done in : " + measurePerf(Variance::varianceStreams, population) + " msecs");

...
public class AsyncTutor1 extends CompletableFutureBase {
  ...
  /**
   * Modify this example by using asynchronous calls so that it was executing in 2 seconds
   */
  @Test
  public void testThenCombineSync() throws Exception {
    long start = System.nanoTime();

    CompletableFuture<Integer> initial = CompletableFuture.supplyAsync(this::slowInit);
    CompletableFuture<Integer> future1 = initial.thenApplyAsync(this::slowIncrement);
    CompletableFuture<Integer> future2 = initial.thenApplyAsync(this::slowIncrement);
